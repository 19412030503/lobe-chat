export default {
  ...
  management: {
    ...
    quota: {
      balance: '额度余额',
      balancePlaceholder: '请输入额度余额',
      confirmResetUsage:
        '确定要重置用户「{{name}}」的已使用额度吗？此操作将清空该用户的使用记录累计值。',
      limit: '个人限额',
      limitHint: '留空表示无限额，设置为0表示禁止使用',
      limitPlaceholder: '请输入个人限额',
      memberQuotas: '成员额度管理',
      messages: {
        creditUpdated: '组织额度更新成功',
        quotaUpdated: '成员额度更新成功',
        usageReset: '已使用额度重置成功',
      },
      noMembers: '该组织暂无成员,请先在「用户管理」中添加成员到此组织',
      noOrganization: '您未加入任何组织',
      noOrganizations: '暂无组织，请先在「组织管理」中创建组织',
      organizationCreditInfo: '组织额度信息',
      organizationCredits: '组织额度总览',
      organizationName: '组织名称',
      pleaseSelectOrganization: '请先选择组织',
      remaining: '剩余额度',
      resetUsage: '重置已使用额度',
      selectOrganization: '选择组织',
      setCredit: '设置额度',
      setMemberQuota: '设置成员额度',
      setOrganizationCredit: '设置组织额度',
      setQuota: '设置额度',
      total: '总额度',
    ...
    statistics: {
      ...
      overview: '使用统计概览',
      selectOrganization: '选择组织',
      textTotalTokens: '文字总 Token',
      textUsageDetail: '文字使用详情',
      threeDCount: '3D 生成次数',
      totalCreditsUsed: '总消耗额度',
      totalTokens: '总 Token',
      userImageCount: '图片生成',
      userTextTokens: '文本 Token',
      userThreeDCount: '3D 生成',
    },
    status: {
      active: '正常',
      disabled: '已禁用',
